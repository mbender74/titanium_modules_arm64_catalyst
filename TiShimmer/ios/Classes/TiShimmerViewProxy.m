...
#import "TiShimmerView.h"
#import "TiShimmerViewProxy.h"
#import "TiUtils.h"


#define __view ((TiShimmerShimmerView *)self.view)


@implementation TiShimmerShimmerViewProxy {}
...
- (void)setShimmeringPauseDuration:(id)args
{
    ENSURE_UI_THREAD(setShimmeringPauseDuration, args);
    __view.shimmeringPauseDuration = [TiUtils floatValue:args];
}
...
- (id)shimmeringPauseDuration
{
    return [NSNumber numberWithFloat:__view.shimmeringPauseDuration];
}
