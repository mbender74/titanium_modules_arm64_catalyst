...
- (instancetype)init
{
  ...
  if (nil != self) {
    ...
    _shimmeringPauseDuration = 0.8;
    _shimmeringSpeed = 400.0;
...
- (void)_updateShimmering
{
  ...
  if (!_shimmering) {
    ...
    CFTimeInterval animationDuration = (CGRectGetWidth(self.bounds) / _shimmeringSpeed) + _shimmeringPauseDuration;
